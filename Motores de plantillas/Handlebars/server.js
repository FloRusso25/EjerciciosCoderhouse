...
//llamadas
app.get('/', (req, res) => {
    res.render('main', {layout: 'index', getStatus: false, postStatus: false, mainStatus : true} )
})
app.get('/productos', (req, res) => {
    const data = productos.getAll()
    console.log("GET todos los productos")
    console.log(data)
    res.render('main', {layout: 'index', getData: data, getStatus: true, postStatus: false, mainStatus : false} )
})
...
app.post('/productos', (req, res) => { 
    ...
    res.render('main', {layout: 'index', postData: data, getStatus: false, postStatus: true, mainStatus : true})
})
